...
const ordersUrl = 
 ...
 + `/values/${encodeURIComponent(sheetName)}?alt=json&key=${apiKey}`;
...
// —————————————————————————————
// BOX CALCULATION (24 & 12 only)
// —————————————————————————————
function calculateBoxes(n) {
  let rem = n;
  const counts = {24:0, 12:0};
...
function renderOrder() {
  ...
  // alphabetical items
  o.items.sort((a,b) =>
    a.itemTitle.localeCompare(b.itemTitle, undefined, { sensitivity:'base' })
  );
...
// —————————————————————————————
// PICKER IFRAME TOGGLE
// —————————————————————————————
document.getElementById('openPickerBtn').onclick = () => {
